...
//        CGContextSetFillColorWithColor(ctx, UIColor.redColor().CGColor );
    ...
    override func layoutSubviews(){
        ...
        message.frame = CGRect( x: w * 0.1, y: h * 0.02, width: w * 0.8, height: h * 0.18)
        
        username.frame = CGRect( x: w * 0.1, y: h * 0.26, width: w * 0.8, height: h * 0.2)
        username.layer.sublayerTransform = CATransform3DMakeTranslation( w * 0.1, 0, 0);

        log.frame = CGRect( x: w * 0.1, y: h * 0.55, width: w * 0.3, height: h * 0.15)
        log.layer.cornerRadius = h * 0.05
        
        cancel.frame = CGRect( x: w * 0.6, y: h * 0.55, width: w * 0.3, height: h * 0.15)
