...
class MasterViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
   ...
   // var allSelectedManuals = []
    ...
    func loadCellDescriptors() {
        ...
        // We should only need 1 loop and all the fields should be enter dynamically
        // Everything has to be stack under each chapter
        // Chapter A - Section A - Task A - Sub-Task - Sub-Task - Sub-Task
        //             Section B - Task B - Task B - Task B
        //             Section C - Task C - Task C - Sub-Task C
        
        // Chapter B - Section A - Task A - Sub-Task A - Sub-Task A
